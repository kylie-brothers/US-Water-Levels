...
#All years
ggplot(AK_missing, aes(x = year(ymd(Date)))) +
  geom_bar()+
...
ggplot(AK_missing_2013, aes(x = month(ymd(Date)))) +
  geom_bar()+
  scale_x_continuous(breaks=seq(1,12,by=1)) +
  scale_y_continuous(breaks=seq(0,1,by=1)) +
  labs(x = "Month", y = "Count", title = "AK Missing Dates in 2013 by Month") +
  theme_minimal()

# 2016
AK_missing_2016 <- AK_missing %>% filter(year(ymd(Date))==2016)
ggplot(AK_missing_2016, aes(x = month(ymd(Date)))) +
  geom_bar()+
  scale_x_continuous(breaks=seq(1,12,by=1)) +
  scale_y_continuous(breaks=seq(0,1,by=1)) +
  labs(x = "Month", y = "Count", title = "AK Missing Dates in 2016 by Month") +
  theme_minimal()
```
